...
import dom.butterdombutton.exception.InvalidOptionException;
import dom.butterdombutton.model.ButterflyOption;

import static dom.butterdombutton.view.ButterdomButton.EAST;
import static dom.butterdombutton.view.ButterdomButton.NORTH;
import static dom.butterdombutton.view.ButterdomButton.NORTH_EAST;
import static dom.butterdombutton.view.ButterdomButton.NORTH_WEST;
import static dom.butterdombutton.view.ButterdomButton.SOUTH;
import static dom.butterdombutton.view.ButterdomButton.SOUTH_EAST;
import static dom.butterdombutton.view.ButterdomButton.SOUTH_WEST;
import static dom.butterdombutton.view.ButterdomButton.WEST;

/**
 * Created by kevindom on 27/05/17.
 */

class ButterdomModel implements IButterdomModel {
    ...
    ButterdomModel(Context context) {
